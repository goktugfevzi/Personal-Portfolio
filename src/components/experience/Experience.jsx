    ...
    <section id="experience">
      ...
      <div className="container experience_container">
        <div className="experience_frontend">
          ...
          <div className="experience_content">
            <article className="experience_details">
              ...
              <img src={reactnative} className="experience_details-icon" alt="react-native"/>
              <div>
                <h4>React Native</h4>
        ...
        <div className="experience_backend">
          ...
          <div className="experience_content">
            <article className="experience_details">
              <img src={csharp} className="experience_details-icon" alt="c-sharp"/>
              <div>
                <h4>C#</h4>
                <small className="text-light">Experienced</small>
              </div>
            ...
            <article className="experience_details">
              <img src={dotnet} className="experience_details-icon" alt="dotnet"/>
              <div>
                <h4>.Net Framework</h4>
                <small className="text-light">Experienced</small>
              </div>
            ...
            <article className="experience_details">
              <img src={firebase} className="experience_details-icon" alt="firebase"/>
              <div>
                <h4>FireBase</h4>
                <small className="text-light">Intermediate</small>
              </div>
